...
//If statement validates that the desired password length is at least 8 and no more than 128.  If this is not validated, an alert is made and the visitor is sent back to the beginning of the process.
...
//To ensure at least one character type is used, the following if statement is used to check that at least one character type has been selected.  If this not validated, an alert is made and the visitor is sent back to the beginning of the process.
